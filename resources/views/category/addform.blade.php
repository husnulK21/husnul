      ...
      <div class="row">
	   ...
	   {{ csrf_field() }}
		...
		<div class="box-body">
                ...
                <input title="Nama Kategori"type="text" name="kategori" autocomplete="off" required class="form-control">
				</div><br>
				<div class="input-group">
				...
				<div class="input-group">
                <span class="input-group-addon"><i class="fa fa-list-alt"></i> Tgl</span>
                <input title="tanggal"type="date" name="tgl" autocomplete="off" required class="form-control">
				</div>
